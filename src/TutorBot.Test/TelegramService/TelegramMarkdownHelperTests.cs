...
public class TelegramMarkdownHelperTests
{
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("hello_world");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("hello*world");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Text **bold** text");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Text _italic_ text");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Text `code` text");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Text ```block``` text");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Text ~~strike~~ text");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Hello **bold** and _italic_ and `code`");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("Price: 10.99$ (discount!)");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("**bold** _italic_ [link](url)");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("x[y]z");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("**_bold italic_** and ~~strike~~");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("_*[]()~`>#+-=|{}.!");
        result.ShouldBe(@"\_\*\[\]\(\)\~\`\>\#\+\-\=\|\{\}\.\!");
    }
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("not *bold");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("# header");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("- item");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("+ plus");
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("a=b");
        result.ShouldBe("a\\=b");
    }
    ...
    {
        string result = TelegramMarkdownHelper.EscapeMarkdownV2("hello!");
